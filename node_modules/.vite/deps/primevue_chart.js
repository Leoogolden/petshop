...
var DomHandler = {
  ...
  createElement: function createElement(type2) {
    ...
    if (type2) {
      var element = document.createElement(type2);
...
var _default = function() {
  function _default2(_ref) {
    var init = _ref.init, type2 = _ref.type;
...
var script2 = {
  ...
  methods: {
    initChart: function initChart() {
      var _this = this;
      import("./auto-5OGRAVDM.js").then(function(module) {
        if (_this.chart) {
          _this.chart.destroy();
          _this.chart = null;
        }
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _objectSpread4(_objectSpread4({}, _ctx.canvasProps), _ctx.ptm("canvas"))), null, 16, _hoisted_1)], 16);
}
